...
static const _TargetCoordinates_type_support_symbol_names_t _TargetCoordinates_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_service_interfaces, msg, TargetCoordinates)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_service_interfaces, msg, TargetCoordinates)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_service_interfaces, msg, TargetCoordinates)() {
  return &::my_service_interfaces::msg::rosidl_typesupport_c::TargetCoordinates_message_type_support_handle;
}
