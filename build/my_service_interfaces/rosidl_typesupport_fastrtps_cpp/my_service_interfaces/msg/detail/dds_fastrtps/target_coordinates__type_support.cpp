...
#include "my_service_interfaces/msg/detail/target_coordinates__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_service_interfaces::msg::TargetCoordinates & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_service_interfaces::msg::TargetCoordinates & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
...
{
  auto typed_message =
    static_cast<const my_service_interfaces::msg::TargetCoordinates *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_service_interfaces::msg::TargetCoordinates *>(
    untyped_ros_message);
...
{
  return &my_service_interfaces::msg::typesupport_fastrtps_cpp::_TargetCoordinates__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_service_interfaces, msg, TargetCoordinates)() {
  return &my_service_interfaces::msg::typesupport_fastrtps_cpp::_TargetCoordinates__handle;
}
