...
#include "my_service_interfaces/srv/detail/spider_goal__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_service_interfaces::srv::SpiderGoal_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_service_interfaces::srv::SpiderGoal_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
...
{
  auto typed_message =
    static_cast<const my_service_interfaces::srv::SpiderGoal_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_service_interfaces::srv::SpiderGoal_Request *>(
    untyped_ros_message);
...
{
  return &my_service_interfaces::srv::typesupport_fastrtps_cpp::_SpiderGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_service_interfaces, srv, SpiderGoal_Request)() {
  return &my_service_interfaces::srv::typesupport_fastrtps_cpp::_SpiderGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_service_interfaces
cdr_serialize(
  const my_service_interfaces::srv::SpiderGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: data
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_service_interfaces::srv::SpiderGoal_Response & ros_message)
{
  // Member: data
  {
    cdr >> ros_message.data;
...
{
  auto typed_message =
    static_cast<const my_service_interfaces::srv::SpiderGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<my_service_interfaces::srv::SpiderGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &my_service_interfaces::srv::typesupport_fastrtps_cpp::_SpiderGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_service_interfaces, srv, SpiderGoal_Response)() {
  return &my_service_interfaces::srv::typesupport_fastrtps_cpp::_SpiderGoal_Response__handle;
}
...
{
  return &my_service_interfaces::srv::typesupport_fastrtps_cpp::_SpiderGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_service_interfaces, srv, SpiderGoal)() {
  return &my_service_interfaces::srv::typesupport_fastrtps_cpp::_SpiderGoal__handle;
}
