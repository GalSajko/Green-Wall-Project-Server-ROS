...
static const _SetValue_Request_type_support_symbol_names_t _SetValue_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_service_interfaces, srv, SetValue_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_service_interfaces, srv, SetValue_Request)),
  }
};
...
{
  return &::my_service_interfaces::srv::rosidl_typesupport_cpp::SetValue_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_service_interfaces, srv, SetValue_Request)() {
  return get_message_type_support_handle<my_service_interfaces::srv::SetValue_Request>();
}
...
static const _SetValue_Response_type_support_symbol_names_t _SetValue_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_service_interfaces, srv, SetValue_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_service_interfaces, srv, SetValue_Response)),
  }
};
...
{
  return &::my_service_interfaces::srv::rosidl_typesupport_cpp::SetValue_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_service_interfaces, srv, SetValue_Response)() {
  return get_message_type_support_handle<my_service_interfaces::srv::SetValue_Response>();
}
...
static const _SetValue_type_support_symbol_names_t _SetValue_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_service_interfaces, srv, SetValue)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_service_interfaces, srv, SetValue)),
  }
};
...
{
  return &::my_service_interfaces::srv::rosidl_typesupport_cpp::SetValue_service_type_support_handle;
}
