...
#include "gwpspider_interfaces/msg/detail/walking_instructions__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const gwpspider_interfaces::msg::WalkingInstructions & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  gwpspider_interfaces::msg::WalkingInstructions & ros_message)
{
  // Member: poses
...
{
  auto typed_message =
    static_cast<const gwpspider_interfaces::msg::WalkingInstructions *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<gwpspider_interfaces::msg::WalkingInstructions *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _WalkingInstructions__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const gwpspider_interfaces::msg::WalkingInstructions *>(
...
static size_t _WalkingInstructions__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_WalkingInstructions(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _WalkingInstructions__callbacks = {
...
static rosidl_message_type_support_t _WalkingInstructions__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_WalkingInstructions__callbacks,
...
{
  return &gwpspider_interfaces::msg::typesupport_fastrtps_cpp::_WalkingInstructions__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gwpspider_interfaces, msg, WalkingInstructions)() {
  return &gwpspider_interfaces::msg::typesupport_fastrtps_cpp::_WalkingInstructions__handle;
}
