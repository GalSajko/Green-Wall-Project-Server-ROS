...
class Metaclass_SpiderGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_service_interfaces.srv.SpiderGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from my_service_interfaces.srv import _spider_goal
...
class SpiderGoal(metaclass=Metaclass_SpiderGoal):
    from my_service_interfaces.srv._spider_goal import SpiderGoal_Request as Request
    from my_service_interfaces.srv._spider_goal import SpiderGoal_Response as Response
