...
#ifndef MY_SERVICE_INTERFACES__SRV__DETAIL__SET_VALUE__FUNCTIONS_H_
#define MY_SERVICE_INTERFACES__SRV__DETAIL__SET_VALUE__FUNCTIONS_H_
...
/// Initialize srv/SetValue message.
/**
...
/// Create srv/SetValue message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * my_service_interfaces__srv__SetValue_Request__init().
...
/// Destroy srv/SetValue message.
/**
 * It calls
 * my_service_interfaces__srv__SetValue_Request__fini()
...
/// Check for srv/SetValue message equality.
/**
...
/// Initialize array of srv/SetValue messages.
/**
...
/// Finalize array of srv/SetValue messages.
/**
 * It calls
 * my_service_interfaces__srv__SetValue_Request__fini()
...
/// Create array of srv/SetValue messages.
/**
 * It allocates the memory for the array and calls
 * my_service_interfaces__srv__SetValue_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetValue messages.
/**
 * It calls
 * my_service_interfaces__srv__SetValue_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetValue message array equality.
/**
...
/// Copy an array of srv/SetValue messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * my_service_interfaces__srv__SetValue_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_service_interfaces
...
/**
 * It calls
 * my_service_interfaces__srv__SetValue_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_my_service_interfaces
...
/**
 * It allocates the memory for the array and calls
 * my_service_interfaces__srv__SetValue_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_service_interfaces
...
/**
 * It calls
 * my_service_interfaces__srv__SetValue_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MY_SERVICE_INTERFACES__SRV__DETAIL__SET_VALUE__FUNCTIONS_H_
